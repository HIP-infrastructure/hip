...
const spaces: Doc[] = [
	{
		...
		description: 'The HIP is an open-source platform designed for large scale and optimized collection, storage, curation, sharing and analysis of multiscale Human iEEG data at the international level',
	...
	// },
	{
		...
		url: `/apps/forms/`,
		description: 'Hi! We would love to get feedback from our users about our product. Please leave a review or contact us through this form. Thank you!',
