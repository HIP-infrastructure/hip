...
import {
    Button, Grid, Typography, Paper, useTheme, Box, Hidden, Alert, Avatar
} from '@mui/material'
...
function FileUpload({ onFileChange, onError }: Props) {
     ...
     * @returns void
     */
    const renderPreview = (event: React.ChangeEventHandler<HTMLInputElement>, filesTab: any) => {
        setAnimate(false)
        setError(null)
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Typography variant="h6"><b>{"Upload file"}</b></Typography>
